---
title: "240_scRNA_Macrophage_composition"
...
## load global vars: 
source("src/global_vars.R")
clrs$cell_type=clrs$cluster_label$T.super[1:10]
names(clrs$cell_type)=names(table(Macro$MultimodalClusters))
```
...
scrna_cell_tbl$cell_type=Macro$MultimodalClusters
...
plist_scrna <- default_comp_grid_list(
  scrna_sample_tbl,
  cell_type, "Interferon.M", cell_type, facet = sample_id,
...
pgrid_supplement
 ...
 ggsave_pdf(filename = "figures/240_scRNA_Macrophage_composition/240_comp_grid_per_animal_Macrophage.pdf",
           pgrid_supplement, width = 4, height = 8)
 ggsave_png(filename = "figures/240_scRNA_Macrophage_composition/240_comp_grid_per_animal_Macrophagel.png",
           pgrid_supplement, width = 4, height = 8)
...
ggsave_pdf("figures/240_scRNA_Macrophage_composition/240_Macrophage_scrna_odds_ratio_strain.pdf", p_scrna_odds_ratio,
           width = 4.35, height = 5.25)

ggsave_png("figures/240_scRNA_Macrophage_composition/240_Macrophage_scrna_odds_ratio_strain.png", p_scrna_odds_ratio,
          width = 4.35, height = 5.25)
